...
<Callout emoji="ℹ️">
  **Subscribe to the FWB Event Calendar**
  On the [events page](https://www.fwb.help/events), click on the `+ Google Calendar` link in the bottom-right of the calendar to subscribe to the FWB Events calendar.
</Callout>
...
<Callout emoji="ℹ️">
  **About Voice Chat Channels**
  Voice chats take place in the following channels, in the "CONVERSATIONS/EVENTS" category of the Discord. See [Voice Chat Channels](#) for a complete overview. 
</Callout>
