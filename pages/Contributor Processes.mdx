...
- Once a candidate is approved and the FWB Operations Team shares an offer letter, that role must be:
(a) Removed from FWB’s job board 
(b) Publicized in FWB’s Organizational Chart, FWB’s Wiki (Coming SoonTM), and FWB’s #contributors channel in #public-works. 
