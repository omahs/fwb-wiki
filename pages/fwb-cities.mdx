...
![Hub and Spoke network map from Impact Networks](cities-1.png)
...
![Multi-hub network map from Impact Networks](cities-2.png)
...
![Local channels as of Season 4.](cities-3.png)